...
app.use(function(req, res, next) {
  var allowedOrigins = ['https://cs5610-sp20-team18.herokuapp.com', 'http://localhost:4200', 'http://127.0.0.1:9000', 'http://localhost:9000', 'http://localhost:3000', 'http://localhost:3001'];
